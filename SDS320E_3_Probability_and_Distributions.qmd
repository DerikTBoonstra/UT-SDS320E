...
:::{.fragment}
[$$X \sim \mathcal{N}(\mu, \sigma).$$]{.mysolution}
:::
...
The *Standard Normal* distribution is a special case of the *Normal* distribution with mean $\mu = 0$ and $\sigma = 1$ and is denoted by [[$Z \sim \mathcal{N}(0, 1).$]{.mysolution}]{.fragment}
...
Suppose $X \sim \mathcal{N}(20, 5)$. Find the z-score for the following.
...
Suppose $X \sim \mathcal{N}(\mu, \sigma).$ What is the distribution of $\bar{X}$?
:::
...
Suppose $X$ is normally distributed with mean $\mu$ and standard deviation $\sigma$, i.e $X \sim \mathcal{N}(\mu, \sigma)$. Then, the sampling distribution of $\bar{X}$ is 

:::{.fragment}
[$$\bar{X} \sim \mathcal{N}(\mu, \sigma/\sqrt{n})$$]{.mysolution}
:::
...
:::{.fragment}
[$X \sim \mathcal{N}(\mu = 12, \sigma = 0.5)$]{.mysolution}
:::
...
:::{.fragment}
[$\bar{X} \sim \mathcal{N}(12, 0.5/\sqrt{10})$]{.mysolution}
:::
...
:::{.fragment}
[$$\bar{X} \stackrel{\cdot}{\sim} \mathcal{N}(\mu, \sigma/\sqrt{n}).$$]{.mysolution} [note: $\stackrel{\cdot}{\sim}$ means approximately distributed]{.subtext}
:::
...
:::{.fragment}
[$\bar{X} \stackrel{\cdot}{\sim} \mathcal{N}(100, 10/\sqrt{49})$]{.mysolution}
:::
